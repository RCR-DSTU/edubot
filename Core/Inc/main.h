...
#define EXTI1_EXTI_IRQn EXTI2_IRQn
...
#define BTN2_PWM_Pin GPIO_PIN_8
#define BTN2_PWM_GPIO_Port GPIOA
#define BTN1_PWM_Pin GPIO_PIN_9
#define BTN1_PWM_GPIO_Port GPIOA
#define LED_PIN_Pin GPIO_PIN_10
#define LED_PIN_GPIO_Port GPIOA
#define LED_PIN_EXTI_IRQn EXTI15_10_IRQn
#define EXTI5_Pin GPIO_PIN_15
#define EXTI5_GPIO_Port GPIOA
#define EXTI5_EXTI_IRQn EXTI15_10_IRQn
#define EXTI2_Pin GPIO_PIN_3
#define EXTI2_GPIO_Port GPIOB
#define EXTI2_EXTI_IRQn EXTI3_IRQn
#define EXTI3_Pin GPIO_PIN_4
#define EXTI3_GPIO_Port GPIOB
#define EXTI3_EXTI_IRQn EXTI4_IRQn
#define EXTI4_Pin GPIO_PIN_5
#define EXTI4_GPIO_Port GPIOB
#define EXTI4_EXTI_IRQn EXTI9_5_IRQn
